      ...
      <NavMenu>
        ...
        <img src={userProfile} alt="user profile"/>
          <div className="userCredencials">
            ...
            <span>
              {dataJobs.loading ? 'carregando' : (
                <>
                  {
                    dataJobs.data.map(value => {
                      if (value.id === userInfo.job) {
                        return value.name
                      }
                      return  
                    })
          ...
          <ul>
            ...
            <li>
              ...
              <ul className="submenu">
                <li><Link to="/setores/">Listar</Link></li>
                <li><Link to="/create/setores/">Criar</Link></li>
              </ul>
            </li>
            <li>
              Cargos
              <ul className="submenu">
                <li><Link to="/cargos/">Listar</Link></li>
                <li><Link to="/create/cargos/">Criar</Link></li>
              </ul>
            </li>
          </ul>
        </div>
          ...
          <button type="button">
            <Link to="/create/">
              <svg width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M19.25 17.5C19.432 17.5 19.6088 17.514 19.7838 17.5402C18.5354 18.4299 17.5179 19.6053 16.8162 20.9682C16.1145 22.3311 15.7489 23.8421 15.75 25.375C15.75 26.817 16.0667 28.1873 16.6355 29.414C15.4798 29.6449 14.3035 29.7575 13.125 29.75C7.154 29.75 3.5 27.2195 3.5 23.625V21C3.5 20.0717 3.86875 19.1815 4.52513 18.5251C5.1815 17.8687 6.07174 17.5 7 17.5H19.25Z" fill="white"/>
            ...
            <button type="button" onClick={handleLogout}>
              <Link to="#">
                <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M23 4H7C6.46957 4 5.96086 4.21071 5.58579 4.58579C5.21071 4.96086 5 5.46957 5 6V30C5 30.5304 5.21071 31.0391 5.58579 31.4142C5.96086 31.7893 6.46957 32 7 32H23C23.5304 32 24.0391 31.7893 24.4142 31.4142C24.7893 31.0391 25 30.5304 25 30V24H15.63C15.3648 24 15.1104 23.8946 14.9229 23.7071C14.7354 23.5196 14.63 23.2652 14.63 23C14.63 22.7348 14.7354 22.4804 14.9229 22.2929C15.1104 22.1054 15.3648 22 15.63 22H25V6C25 5.46957 24.7893 4.96086 24.4142 4.58579C24.0391 4.21071 23.5304 4 23 4V4Z" fill="white"/>
                  <path d="M28.16 17.28C27.9687 17.1162 27.7226 17.0306 27.4709 17.0403C27.2193 17.05 26.9805 17.1544 26.8024 17.3324C26.6243 17.5105 26.52 17.7493 26.5103 18.001C26.5006 18.2526 26.5862 18.4987 26.75 18.69L30.13 22H25V24H30.13L26.75 27.46C26.6453 27.5497 26.5603 27.66 26.5003 27.784C26.4403 27.9081 26.4065 28.0432 26.4012 28.181C26.3959 28.3187 26.4191 28.456 26.4694 28.5843C26.5196 28.7127 26.5959 28.8292 26.6933 28.9267C26.7908 29.0241 26.9074 29.1004 27.0357 29.1506C27.164 29.2009 27.3013 29.2241 27.4391 29.2188C27.5768 29.2135 27.7119 29.1798 27.836 29.1197C27.96 29.0597 28.0704 28.9747 28.16 28.87L34 23.07L28.16 17.28Z" fill="white"/>
                </svg>
              </Link>
            </button>
          ) : (
